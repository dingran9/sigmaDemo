...
function showThisDetail(obj){
    if($(obj).children().children().hasClass("fa-angle-double-up")){
        $(obj).parent().next().hide();
        $(obj).children().children().addClass("fa-angle-double-down").removeClass("fa-angle-double-up")
    }else{
        $(obj).parent().next().show();
        $(obj).children().children().addClass("fa-angle-double-up").removeClass("fa-angle-double-down")
    }
}
