...
$(document).ready(function() {
    ...
    $('.minifyme').click(function(e) {
        ...
        if($('body').hasClass("minified")){
            $("#logo-img").attr("src","../../static/images/cniaaslogo.png").addClass("minify-logo-img");
            $("#logo-group").addClass("minify-logo-group");
        }else{
            $("#logo-img").attr("src","../../static/smartadmin/img/logo_ezcloud.png").removeClass("minify-logo-img");
